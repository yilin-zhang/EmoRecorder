...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(485, 583)
        self.instrumentBox = QtWidgets.QComboBox(Dialog)
        self.instrumentBox.setGeometry(QtCore.QRect(190, 261, 104, 26))
        ...
        self.deviceChoices.setGeometry(QtCore.QRect(60, 100, 361, 31))
        self.deviceChoices.setWordWrap(True)
        self.deviceChoices.setObjectName("deviceChoices")
        self.line_4 = QtWidgets.QFrame(Dialog)
        self.line_4.setGeometry(QtCore.QRect(30, 410, 431, 20))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.nameEdit = QtWidgets.QLineEdit(Dialog)
        self.nameEdit.setGeometry(QtCore.QRect(190, 220, 113, 21))
        self.nameEdit.setObjectName("nameEdit")
        self.deviceChoices_2 = QtWidgets.QLabel(Dialog)
        self.deviceChoices_2.setGeometry(QtCore.QRect(60, 180, 361, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.deviceChoices_2.setText(_translate("Dialog", "Type in your name"))
